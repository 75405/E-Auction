	...
	<div class="box">
		<form action="loginverwerk.php" method="POST">
			...
			<div class="form-group">
				...
				<small id="emailHelp" class="des">Deel nooit u inlog gegevens met anderen.</small>
			</div>
			<div class="form-group">
			...
			<p class="content">Heeft u nog geen account? <a href="register.php" class="text">Maak er dan nu een aan!</a>
			</p>
